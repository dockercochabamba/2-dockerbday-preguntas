	...
	<nav class="navbar is-info is-fixed-top" role="navigation" aria-label="main navigation">
		<div class="navbar-brand">	
			<a class="navbar-item" href="/">
				<img src="https://hub.docker.com/public/images/logos/mini-logo.svg" alt="Docker Cochabamba">
			</a>
			<a class="navbar-item" href="https://www.facebook.com/dockercochabamba">
				Docker Cochabamba
			</a>
		</div>
	</nav>
			...
			<div class="content">
				...
				<div class="columns">
					...
					<div class="column is-two-fifths">
						...
						<h1 class="title">Docker Birthday #5</h1>
						<form action="/" method="post" accept-charset="utf-8">
							<div class="field">
								<label class="label" for="tu_nombre">Nombre:</label>
								<div class="control">
									<input class="input" type="text" name="tu_nombre" id="tu_nombre" placeholder="ej. Pipey McPiperson" required>
								</div>
							</div>
